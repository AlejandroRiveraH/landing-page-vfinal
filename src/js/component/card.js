		...
		<div className="card">
			...
			<div className="card-body text-center">
				...
				<p className="card-text">
					"Tucan: Se denomina tucán a los miembros de la familia
					Ramphastidae, que se compone de 5 géneros y aproximadamente
					42 especies. Se trata de un ave cuyo nombre proviene de la
					palabra tukana, que a su vez pertenece a la lengua tupí. Es
					además fácilmente reconocible por su pico largo y colorido;
					y asociado con la selva y el ambiente tropical."
				</p>
			</div>
		...
		<div className="card">
			...
			<div className="card-body text-center">
				...
				<p className="card-text">
					...
					convertido en especie muy demandada comercialmente. Es uno
					de los loros más populares del mundo y suele vivir con los
					hombres adoptándolo como una mascota. Estos pájaros tienen
					la habilidad de imitar de forma precisa el habla humana."
				</p>
			</div>
			<div className="card-footer justify-content-center text-center">
				<a className="btn btn-primary" href={data.button.url}>
